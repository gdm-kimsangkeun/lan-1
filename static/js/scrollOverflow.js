  ...
  (function (window, document) {
    window.fp_scrolloverflow = (function () {
      ...
      function getPaddings(element) {
        ...
        if (section != null) {
          return (
            parseInt(getComputedStyle(section)['padding-bottom']) + parseInt(getComputedStyle(section)['padding-top'])
          );
        }
      ...
      var iscrollHandler = {
        ...
        isScrolled: function (type, scrollable) {
          ...
          if (type === 'top') {
            ...
            return (
              0 - scroller.y + fp_utils.getScrollTop(scrollable) + scrollable.offsetHeight >= scrollable.scrollHeight
            );
          }
        },
