    ...
    if (!$.fn.slickNav) {
      $.fn.slickNav = function (item, ops) {
        ...
        function parseProgress() {
          ...
          var total = $childLength < 10 ? $childLength : $childLength;
  
          var progressHTML =
            '<p class="progress__current">1</p><div class="progress__track"><div class="progress__fill"></div></div><p class="progress__total">' +
            total +
            '</p>';
